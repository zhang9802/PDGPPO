...
if __name__=="__main__":
    ...
    name1 = './figs/compare_isac_conv_v1'
    ...
    plt.savefig(name1 + '.eps', dpi=1600)
    # plt.savefig(name1 + '.eps', dpi=1600)

    name2 = './figs/compare_isac_pos_v1.eps'
    ...
    plt.savefig(name2, dpi=1600)

    name3 = './figs/compare_isac_val_v1.eps'
    ...
    ax.set_ylabel('Maximum achievable rate (bps/Hz)', fontsize=16, labelpad=10)
