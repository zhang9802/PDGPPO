...
class TD3():
    def __init__(self, state_dim, action_dim, args, device, max_action=1.0,policy_freq=4, policy_noise=0.1, noise_clip=0.1):
        ...
        self.critic_optimizer = torch.optim.Adam(self.critic.parameters(), lr=5*args.lr, weight_decay=args.decay)
