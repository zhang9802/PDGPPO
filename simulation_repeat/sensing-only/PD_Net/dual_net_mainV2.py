...
if __name__=="__main__":
    ...
    parser.add_argument("--lr_p", type=float, default=5e-5, help="Learning rate of primary network,1e-5")
    parser.add_argument("--lr_d", type=float, default=5e-5, help="Learning rate of dual network,1e-5")
    ...
    parser.add_argument("--penalty_F", type=float, default=100.0, help="penalty factor for the objective function")
    ...
    parser.add_argument("--Gam", default=0.2, type=float, metavar='N', help='sensing power threshold (default: 0.1 W)') #check
