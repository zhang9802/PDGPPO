...
if __name__=="__main__":
    ...
    for ii in range(int(mento_carlo)):
        ...
        parser.add_argument("--K", default=2, type=int, metavar='N', help='Number of ISAC-BS')
        ...
        dqn_type = 'VanillaDQN_mentocarlo' # 'VanillaDQN', 'DoubleDQN'
    ...
    np.save(dqn_type + '.npy', max_value_all)    
