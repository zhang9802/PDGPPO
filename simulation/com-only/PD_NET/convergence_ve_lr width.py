...
conv_32 = np.load('convergence_lr_0.0001_width_p_32.npy')
conv_64 = np.load('convergence_lr_0.0001_width_p_64.npy')
conv_128 = np.load('convergence_lr_0.0001_width_p_128.npy')
plt.figure()
...
plt.legend()
# plt.show(dpi=1200)
plt.savefig('pd_com_con_width.eps',dpi=1200)