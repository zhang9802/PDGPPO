    ...
    for i in range(10):
        with tqdm(total=int(num_episodes / 10),desc='Iteration %d' % i) as pbar:
            ...
            for i_episode in range(int(num_episodes / 10)):
                ...
                pbar.update(1)
    return return_list, max_q_value_list, max_action, max_reward, max_eps_list
...
if __name__=="__main__":
    ...
    parser.add_argument("--epsilon", type=float, default=0.2, help="The std of Gaussian noise for exploration")
    ...
    agent = DQN(state_dim, action_dim, args.hidden_dim, args.lr, args.gamma, args.epsilon,args.target_update, device,dqn_type)

    return_list, max_q_value_list, max_action, max_reward, max_eps_list = train_DQN(agent, env, args.num_episodes, replay_buffer, args.minimal_size, args.batch_size)
    ...
    plt.grid()
    plt.legend()
    plt.savefig(dqn_type + '_eps_reward' + '.png', dpi=900)