...
plt.title('PD-GPPO')
plt.tight_layout()
plt.savefig('./figs/beampattern_1.eps', dpi=600, bbox_inches='tight')
...
plt.title('PD-PPO')
plt.tight_layout()
plt.savefig('./figs/beampattern_2.eps', dpi=600, bbox_inches='tight')
...
plt.title('TD3')
plt.tight_layout()
plt.savefig('./figs/beampattern_3.eps', dpi=600, bbox_inches='tight')
...
plt.title('DDPG')
plt.tight_layout()
plt.savefig('./figs/beampattern_4.eps', dpi=600, bbox_inches='tight')
...
plt.title('PD-DQN')
plt.tight_layout()
plt.savefig('./figs/beampattern_5.eps', dpi=600, bbox_inches='tight')
