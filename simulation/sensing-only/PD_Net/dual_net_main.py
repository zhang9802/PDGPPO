...
def train_net(model_p, device, args, optimizer_p, model_d, optimizer_d, H):
    ...
    plt.grid(True)
    fig_name = 'my_network_' + str(args.lr_p) + '_' + str(args.batch_size) + '_' + str(args.width_p) + '.png'
...
if __name__=="__main__":
    ...
    parser.add_argument("--lr_p", type=float, default=1e-3, help="Learning rate of primary network,1e-5")
    parser.add_argument("--lr_d", type=float, default=1e-3, help="Learning rate of dual network,1e-5")
